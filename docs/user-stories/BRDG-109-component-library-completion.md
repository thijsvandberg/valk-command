...
- [ ] Migrate all inline card patterns to use Card component
- [ ] Migrate all inline input patterns to use TextInput component
- [ ] Migrate all inline tag/badge patterns to use Tag component
- [ ] Migrate all inline button-like elements to use Button component
- [ ] Create shared Modal component and migrate existing modals
- [ ] Create shared Popover component
- [ ] Create shared ConfirmDialog component
- [ ] Create shared Badge component (rounded-full variant of Tag or separate)
- [ ] Ensure all shared components have tests
- [ ] Verify visual consistency after migration (no regressions)
