...
const EXPECTED_ROUTES = [
  ...
  { path: "/sprint-board/[[...slug]]", file: "src/app/(app)/sprint-board/[[...slug]]/page.tsx", name: "Sprint Board" },
  { path: "/epics", file: "src/app/(app)/epics/page.tsx", name: "Epics" },
  { path: "/epics/[key]/write", file: "src/app/(app)/epics/[key]/write/page.tsx", name: "Epic Writer" },
  ...
  { path: "/cleanup", file: "src/app/(app)/cleanup/page.tsx", name: "Cleanup" },
  { path: "/settings", file: "src/app/(app)/settings/page.tsx", name: "Settings" },
  { path: "/settings/deprecated-areas", file: "src/app/(app)/settings/deprecated-areas/page.tsx", name: "Settings Deprecated Areas" },
...
{ path: "/sprint-board/compare", file: "src/app/(app)/sprint-board/compare/page.tsx", name: "Sprint Compare" },
  { path: "/refinement/history", file: "src/app/(app)/refinement/history/page.tsx", name: "Refinement History" },
  ...
  { path: "/bookmarks", file: "src/app/(app)/bookmarks/page.tsx", name: "Bookmarks" },
];
