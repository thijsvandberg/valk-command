  ...
  return (
    <div className={`flex items-center gap-1 ${className ?? "mt-2 pt-2 border-t border-white/[0.04]"}`}>
      ...
      <button
        ...
        className="flex items-center gap-1 rounded px-1.5 py-0.5 text-caption text-white/30 cursor-pointer hover:text-white/50 hover:bg-white/[0.04] active:bg-white/[0.06] transition-colors duration-100"
