...
export function Popover({
  ...
  return (
    <div
      ref={ref}
      className={`absolute top-full z-50 ${alignClass} ${offsetClass} overflow-hidden rounded-xl border border-border-strong bg-[var(--color-surface-floating)] shadow-[0_12px_40px_rgba(0,0,0,0.55),0_4px_12px_rgba(0,0,0,0.3),0_0_0_1px_rgba(255,255,255,0.04)]${className ? ` ${className}` : ""}`}
      {...rest}
    >
      {children}
    </div>
