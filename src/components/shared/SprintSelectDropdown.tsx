          ...
          <div className="border-b border-border-subtle px-2 py-1.5">
            <div className="relative">
              ...
              <input ref={searchRef} type="text" value={search}
                ...
                onKeyDown={nav}
                className="w-full rounded bg-overlay-subtle py-1 pl-6 pr-2 text-body-sm text-text-secondary placeholder:text-text-muted focus:outline-none focus:bg-overlay-default"
                  ...
                  {sec.items.map((opt) => {
                    ...
                    return (
                      <button key={opt.value} ref={(el) => { itemRefs.current[fi] = el; }}
                        ...
                        className="flex w-full items-center gap-2.5 px-3 py-2 text-left cursor-pointer focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-[var(--color-brand-400)]"
