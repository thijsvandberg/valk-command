...
export function BoardFieldToggle({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      />
      {open && (
        <div className="absolute top-full right-0 z-dropdown mt-1.5 flex w-56 flex-col overflow-hidden rounded-xl border border-border-strong bg-surface-floating shadow-xl">
          <BoardFieldList
            visible={visible}
            onChange={onChange}
