...
export function FilterControlsPanel(props: FilterControlsPanelProps) {
  ...
  return (
    <div className="absolute right-0 top-[calc(100%+8px)] z-50 w-[548px] max-w-[calc(100vw-2rem)] overflow-hidden rounded-2xl border border-border-strong bg-[var(--color-surface-floating)] shadow-[var(--shadow-xl)]">
