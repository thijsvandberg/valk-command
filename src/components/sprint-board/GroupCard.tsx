  ...
  return (
    <div className={GROUP_CARD_CLASS}>
      <div
        ...
        className={`group/grouprow flex cursor-pointer select-none items-center gap-3 px-3 py-2.5 hover:bg-[var(--color-surface-elevated-hover)] [transition:background-color_.12s_ease] ${
