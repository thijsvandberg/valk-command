        ...
        {suggestions.map((s) => {
          ...
          return (
            ...
            >
              ...
              {alreadyLinked ? (
                <span className="text-caption text-text-muted">Already linked</span>
              ) : justLinked ? (
                <span className="flex items-center gap-1 text-caption font-medium text-emerald-400">
                ...
                <button
                  ...
                  className="text-caption font-medium text-red-400 cursor-pointer hover:text-red-300 transition-colors duration-150"
                >
                  Retry
                </button>
              ) : (
