          ...
          <div className="flex flex-col rounded-2xl border border-border-strong bg-surface-elevated focus-within:border-[var(--color-brand-500)]/30 transition-colors duration-150">
            ...
            <div ref={inputWrapperRef} style={manualInputHeight ? { height: manualInputHeight } : undefined} className={manualInputHeight ? "overflow-hidden" : undefined}>
              <textarea
                ...
                rows={1}
                className={`w-full resize-none bg-transparent px-3.5 pt-1 pb-1 font-[var(--font-body)] text-body-lg leading-prose text-text-primary placeholder-text-tertiary focus:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-[var(--color-brand-500)]/50 disabled:opacity-50 ${manualInputHeight ? "h-full" : ""}`}
              />
            </div>
